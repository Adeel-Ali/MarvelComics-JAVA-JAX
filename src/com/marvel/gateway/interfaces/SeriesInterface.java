...
public interface SeriesInterface {
    ...
    public Series getSeriesIndividualAsync(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public CharacterDataWrapper getSeriesCharacterWrapperAsync(
            @PathParam("seriesId") String seriesId,
    ...
    @GET
    @Path("/series/{seriesId}/comics")
    @Produces(MediaType.APPLICATION_JSON)
    public ComicDataWrapper getComicsCollectionBySeriesIdAsync(
            @PathParam("seriesId") String seriesId,
    ...
    @GET
    @Path("/series/{seriesId}/creators")
    @Produces(MediaType.APPLICATION_JSON)
    public CreatorDataWrapper getCreatorCollectionBySeriesIdAsync(
            @PathParam("seriesId") String seriesId,
            @QueryParam("comics") String comics,
            @QueryParam("events") String events,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public EventDataWrapper getEventsCollectionBySeriesIdAsync(
            @PathParam("seriesId") String seriesId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
            @QueryParam("creators") String creators,
    ...
    @GET
    @Path("/series/{seriesId}/stories")
    @Produces(MediaType.APPLICATION_JSON)
    public StoryDataWrapper getSeriesStoryCollectionAsync(
            @PathParam("seriesId") String seriesId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
            @QueryParam("creators") String creators,
    ...
    @Path("/series")
    @Produces(MediaType.APPLICATION_JSON)
    public SeriesDataWrapper getSeriesCollectionAsync(
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
