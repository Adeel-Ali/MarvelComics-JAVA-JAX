...
public interface StoriesInterface {
    ...
    public Story getStoryIndividualAsync(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public CharacterDataWrapper getCharacterCollectionByStoryIdAsync(
            @PathParam("storyId") String storyId,
    ...
    @GET
    @Path("/stories/{storyId}/comics")
    @Produces(MediaType.APPLICATION_JSON)
    public ComicDataWrapper getComicsCollectionByStoryIdAsync(
            @PathParam("storyId") String storyId,
    ...
    @GET
    @Path("/stories/{storyId}/creators")
    @Produces(MediaType.APPLICATION_JSON)
    public CreatorDataWrapper getCreatorCollectionByStoryIdAsync(
            @PathParam("storyId") String storyId,
            @QueryParam("comics") String comics,
            @QueryParam("events") String events,
    ...
    @GET
    @Path("/stories/{storyId}/events")
    @Produces(MediaType.APPLICATION_JSON)
    public EventDataWrapper getEventsCollectionByStoryIdAsync(
            @PathParam("storyId") String storyId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
            @QueryParam("creators") String creators,
    ...
    @GET
    @Path("/stories/{storyId}/series")
    @Produces(MediaType.APPLICATION_JSON)
    public SeriesDataWrapper getStorySeriesCollectionAsync(
            @PathParam("storyId") String storyId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
    ...
    @Path("/stories")
    @Produces(MediaType.APPLICATION_JSON)
    public StoryDataWrapper getStoryCollectionAsync(
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
            @QueryParam("creators") String creators,
            @QueryParam("events") String events,
