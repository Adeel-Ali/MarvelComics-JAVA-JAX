...
public interface CreatorsInterface {
    ...
    public Creator getCreatorIndividualAsync(
    ...
    @GET
    @Path("/creators/{creatorId}/comics")
    @Produces(MediaType.APPLICATION_JSON)
    public ComicDataWrapper getComicsCollectionByCreatorIdAsync(
            @PathParam("creatorId") String creatorId,
    ...
    @GET
    @Path("/creators/{creatorId}/events")
    @Produces(MediaType.APPLICATION_JSON)
    public EventDataWrapper getCreatorEventsCollectionAsync(
            @PathParam("creatorId") String creatorId,
            @QueryParam("characters") String characters,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public SeriesDataWrapper getCreatorSeriesCollectionAsync(
            @PathParam("creatorId") String creatorId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public StoryDataWrapper getCreatorStoryCollectionAsync(
            @PathParam("creatorId") String creatorId,
            @QueryParam("characters") String characters,
            @QueryParam("comics") String comics,
            @QueryParam("events") String events,
    ...
    @Path("/creators")
    @Produces(MediaType.APPLICATION_JSON)
    public CreatorDataWrapper getCreatorCollectionAsync(
            @QueryParam("comics") String comics,
            @QueryParam("events") String events,
