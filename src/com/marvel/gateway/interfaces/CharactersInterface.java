...
public interface CharactersInterface {
    ...
    public MCharacter getCharacterIndividualAsync(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public ComicDataWrapper getComicsCharacterCollectionAsync(
            @PathParam("characterId") String characterId,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public EventDataWrapper getCharacterEventsCollectionAsync(
            @PathParam("characterId") String characterId,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public SeriesDataWrapper getCharacterSeriesCollectionAsync(
            @PathParam("characterId") String characterId,
            @QueryParam("comics") String comics,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public StoryDataWrapper getCharacterStoryCollectionAsync(
            @PathParam("characterId") String characterId,
            @QueryParam("comics") String comics,
            @QueryParam("creators") String creators,
            @QueryParam("events") String events,
    ...
    @Path("/characters")
    @Produces(MediaType.APPLICATION_JSON)
    public CharacterDataWrapper getCharacterCollectionAsync(
            @QueryParam("comics") String comics,
            @QueryParam("events") String events,
            @QueryParam("limit") String limit,
            @QueryParam("modifiedSince") String modifiedSince,
